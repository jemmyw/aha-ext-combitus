...
values: 
AttachmentSizeEnum_MINI | AttachmentSizeEnum_MEDIUM | AttachmentSizeEnum_ORIGINAL
;
...
values: 
AvatarSizeEnum_SIZE_16 | AvatarSizeEnum_SIZE_24 | AvatarSizeEnum_SIZE_32 | AvatarSizeEnum_SIZE_40 | AvatarSizeEnum_SIZE_160
;
...
values: 
EpicOrder_workflowBoardPosition | EpicOrder_createdAt | EpicOrder_position
;
...
values: 
ExtensionFieldableTypeEnum_EPIC | ExtensionFieldableTypeEnum_FEATURE | ExtensionFieldableTypeEnum_REQUIREMENT
;
...
values: 
FeatureOrder_workflowBoardPosition | FeatureOrder_createdAt | FeatureOrder_updatedAt | FeatureOrder_position | FeatureOrder_featureBoardPosition
;
...
values: 
InternalMeaning_NOT_STARTED | InternalMeaning_IN_PROGRESS | InternalMeaning_DONE | InternalMeaning_SHIPPED | InternalMeaning_WONT_DO | InternalMeaning_ALREADY_EXISTS
;
...
values: 
NotificationReadEnum_READ | NotificationReadEnum_UNREAD
;
...
values: 
NotificationScopeEnum_PARTICIPATING | NotificationScopeEnum_WATCHING
;
...
values: 
NotificationStarredEnum_STARRED | NotificationStarredEnum_UNSTARRED
;
...
values: 
NotificationTypeEnum_Comment | NotificationTypeEnum_Project | NotificationTypeEnum_Task | NotificationTypeEnum_Release | NotificationTypeEnum_Epic | NotificationTypeEnum_Feature
;
...
values: 
OrderDirection_ASC | OrderDirection_DESC
;
...
values: 
RecordPlacementEnum_TOP | RecordPlacementEnum_BOTTOM
;
...
values: 
RequirementOrder_workflowBoardPosition | RequirementOrder_createdAt | RequirementOrder_updatedAt | RequirementOrder_position
;
...
values: 
TaskStatusEnum_PENDING | TaskStatusEnum_COMPLETE | TaskStatusEnum_APPROVED | TaskStatusEnum_APPROVED_CONDITIONALLY | TaskStatusEnum_REJECTED | TaskStatusEnum_SKIPPED
;
...
values: 
WorkUnitEnum_MINUTES | WorkUnitEnum_POINTS
;
...
type TimestampsInterface = Account | Attachment | Comment | Epic | Extension | ExtensionContribution | ExtensionField | ExtensionInvocation | ExtensionLog | Feature | Iteration | Notification | Project | Release | Requirement | Task | TaskUser | User | Workflow | WorkflowStatus;
